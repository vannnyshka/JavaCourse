package lessons.eight.otladka.java;
...
public class Main {
    ...
    private static Logger errorsLogger = LogManager.getLogger("error");
    private static Logger exceptionsLogger = LogManager.getLogger("exception");
    private static Logger searchLogger = LogManager.getLogger("search");
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            //Тут станции, которые не найдены
    ...
    private static void createStationIndex() {
        ...
        try {
            ...
            exceptionsLogger.warn("Произошло исключение: " + ex);
            ex.printStackTrace();
        }
    }
